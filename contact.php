...
<body>
  ...
  <nav class="navbar navbar-light custom-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><img src="assets/img/logo.png" style="height: 100px;width: 100px"></img></a>
          ...
          <div class="col-md-4 ml-auto order-2" data-aos="fade-up">
            <ul class="list-unstyled">
              <li class="mb-3">
                ...
                <span>540 86th Brooklyn,NY 11209 United States</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Phone</strong>
                <span>+1(619)714-9402</span>
              </li>
              <li class="mb-3">
                <strong class="d-block mb-1">Email</strong>
                <span>angelpuppy62@gmail.com</span>
              </li>
            </ul>
          </div>
